...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        UIImageView *headerImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"user_icon"]];
        ...
        button1.backgroundColor = UIColorFromRGB(0xF6C362);
        [button1 setTitle:@"Simple天气" forState:UIControlStateNormal];
        ...
        button2.backgroundColor = UIColorFromRGB(0xF6C362);
        [button2 setTitle:@"Version 1.0" forState:UIControlStateNormal];
        ...
        button3.backgroundColor = UIColorFromRGB(0xF6C362);
